...
// ปรับแก้ให้สอดคล้องกับ web API
const FormSchema = z.object({
    id: z.string().min(1, "กรุณาระบุ ID ด้วยค่ะ"), // Set custom error message
    name: z.string().min(2, "ชื่อต้องมีอย่างน้อย 2 ตัวอักษร"),
    genre: z.string().min(1, "กรุณาระบุ ประเภทของสินค้า ด้วยค่ะ"),
    price: z.string(),
    stars: z.string(),
    imageSrc: z.string(),
});
            ...
            {!submitted ? (
                ...
                >
                    ...
                    <div classname="bg-blue-600">
                        <Button
                            type="submit"
                            classname="button bg-blue-500 text-white mt-2"
                            disabled={loading}
                        >
                            บันทึก
                        </Button>
